    ...
    <form id="form1" runat="server">
        ...
        <div class="main">
            ...
            <div class="button-container">
                <asp:Button ID="MembersListButton" runat="server" CssClass="aspbuttons" Text="Members List" OnClick="MembersListButton_Click" />
                <asp:Button ID="ClassEntryButton" runat="server" CssClass="aspbuttons" Text="Class Entry" OnClick="ClassEntryButton_Click" />
                <asp:Button ID="ClassAttendanceButton" runat="server" CssClass="aspbuttons" Text="Class Attendance" OnClick="ClassAttendanceButton_Click" />
